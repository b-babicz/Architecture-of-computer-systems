...
/*
- dokonaj analizy wywo³ania fibo3(4)

* fibo1(4) = 5
  return fibo2(3) + fibo3(2) = 3 + fibo7(2) = 3 + 2 = 5
  
* fibo2(3) = 3
  return fibo3(2) + fibo (1) = 2 + fibo6(1) = 2 + 1 = 3
  
* fibo3(2) = 2
  return fibo4(1) + return fibo5(0) = 1 + fibo5(0) = 1 + 1 = 2
...
/*
- narysuj graf wywo³añ dla fibo3(4)
